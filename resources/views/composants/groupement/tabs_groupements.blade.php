...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link active" id="profil-tab{{ $index }}" data-bs-toggle="tab" data-bs-target="#profil{{ $index }}" type="button" role="tab" aria-controls="profil{{ $index }}" aria-selected="true">Postulant</button>
    </li>
